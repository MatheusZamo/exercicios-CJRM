...
const getDadosGitHub = async username => console.log(await user(username))

//getDadosGitHub('MatheusZamo')
...
/*
  ...
  - Exemplos de nomes na "língua do 'P'":
    ...
    - Rafaela => "PRaPfaPePla".
*/
const mySyllables = ['Ma','the','us']

const myNameInPLanguage = mySyllables.reduce((acc,syllable) => acc += `P${syllable}`,'')
...
*/
const myFirstName = 'Matheus'

myFirstName
  .split('')
  //.forEach((letter, index) => console.log(`"${letter}" é a ${index + 1}ª letra do meu nome.`))
