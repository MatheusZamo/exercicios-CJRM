...
const my3FavoriteTVShows = ['Breaking Bad','Game of Thrones','The whitcher']
...
const transformString = String(result).replace('t','T')
//console.log(`A string que a "typeSentence" armazena tem mais de 39 caracteres? ${transformString}.`)
