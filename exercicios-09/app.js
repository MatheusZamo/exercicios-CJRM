...
const amountCharacters = word => word.length

//console.log(amountCharacters('papel'))
...
const smallSentence = words => words.toLowerCase()

//console.log(smallSentence(sentence))
...
const word = (character, word) => word.indexOf(character)

//console.log(word('ã','Estevão'))
...
const checkFruits = (array, item) => array.includes(item)

//console.log(checkFruits(fruits,'abacaxi'))
/*
  06
...
*/
const formula1Cars = ['Mercedes','Red Bull Racing','Ferrari']
const formula1Cars1 = ['Mclaren','Williams','Aston Martin']

const sumArrays = (cars1,cars2) => cars1.concat(cars2)

//console.log(sumArrays(formula1Cars,formula1Cars1))
...
*/
const itens = ['pen','smartphone','computer','mouse']

const removeIten = list => {
  list.pop()
  return list
}

//console.log(removeIten(itens))
/*
  08
...
const checkValue = element => element === null
